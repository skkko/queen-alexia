...
module.exports = GojoMdNx = async (GojoMdNx, m, chatUpdate, store) => {
	...
	//group target \\
const reply = (teks) => {
            GojoMdNx.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` Queen-alexia`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./GojoMedia/alexia.jpg`),"sourceUrl": "https://telegra.ph/file/2ed7226b6255f25e1f2e4.jpg"}}}, { quoted: m})
        }
...
break
	    ...
	    break
            ...
            break
case 'smemex': case 'stickermeme': case 'stickmeme': {
...
🔗 *Media Url* : ${images}`,
	    ...
	    case 'play': case 'dv': case 'yt': {
                if (!text) return reply(`Example : ${prefix + command} lily`)
                let yts = require("yt-search")
                let search = await yts(text)
...
╚═✎🧚‍♀️ Url : ${anu.url}`,
	    ...
	    case 'ytmp3': case 'getmusic': case 'ytaudio': {
                ...
                GojoMdNx.sendImage(m.chat, media.thumb, `┏━✪ 🧚‍♀️Qᴜᴇᴇɴ ᴀʟᴇxɪᴀ yᴏᴜᴛᴜʙᴇ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ🧚‍♀️ ✪━\n╠✎🧚‍♀️ Title : ${media.title}\n╠✎🧚‍♀️ File Size : ${media.filesizeF}\n╠✎🧚‍♀️ Url : ${isUrl(text)}\n╠✎🧚‍♀️ Ext : MP3\n╚═✎🧚‍♀️ Resolution : ${args[1] || '320kbps'}`, m)
...
case 'webtonsearch': case 'webtoon':
            ...
            break
            case 'charactersrc': case 'karakterxxx':
...
And Again Me (King Nexus 🎉) 🐦 Who Helped Assemble This Sexy Script !!!`,unicorn, [{"urlButton": {"displayText": "Group 🔗","url": `${myweb}`}},{"urlButton": {"displayText": "Script🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
